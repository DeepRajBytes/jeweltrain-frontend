        ...
        /> */}
            <figure className="mt-10">
              ...
              <figcaption className="mt-10">
                ...
                />
                <div className="mt-4 flex items-center justify-center gap-2 text-sm sm:text-base flex-wrap">
                  <TypewriterEffectSmooth
                    words={data.CareerPage.CEONAME.split(" ").map((word) => ({
                      text: word,
                    }))}
